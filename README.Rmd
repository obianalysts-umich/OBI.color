...
Reports that we share with OBI sites need to have BCBSM required language and [BCBS logo](files/BCBSM BCN_ProcessBlue_B.png).

Please see this [SOP](https://docs.google.com/document/d/1IKCsZm4JK4Y8GATnl-yibHKvuNX5gkDL-yA5KdWbEiA/edit) for reference. 
